...
# Description
 ...
 - Updates and deletions to individual rows of a table will invalidate its individual cached equivalent (if it is cached)
 ...
 - Cache keys will follow this naming scheme for individual resource queries:
    - <namespace>:<table-name>:<id>
    - EXAMPLE:
       - prod:bathroom_data_primary:9
       - test:bathroom_data_primary:67
       - dev:bathroom_data_primary:8
       - dev:user_data_primary:193
