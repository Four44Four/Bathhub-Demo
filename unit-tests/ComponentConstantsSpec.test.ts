...
describe("component constants match their specifications", () => {
  ...
  test("bathroom-page and alert constants match their specs", () => {
    expect(BathroomPage).toMatchObject({
      ...
      BATHROOM_INFORMATION_PANEL_CORNER_RADIUS_PX: 8,
      BATHROOM_INFORMATION_PANEL_HOVER_ANIMATION_DURATION_MS: 250,
      BATHROOM_INFORMATION_PANEL_HOVER_INTERACT_DARKENING_MULT_FACTOR: 0.7,
      BATHROOM_INFORMATION_PANEL_BACKGROUND_FILL_COLOR: "#E4E4FF",
      BATHROOM_INFORMATION_PANEL_ICON_BUFFER_PX: 5,
      BATHROOM_INFORMATION_PANEL_ARROW_ICON_SIZE_PX: 10,
      BATHROOM_INFORMATION_PANEL_ARROW_ROW_HEIGHT_PX: 15,
      BATHROOM_INFORMATION_PANEL_PADDING_PX: 10,
      BATHROOM_INFORMATION_PANEL_EXISTENCE_VOTE_BAR_WIDTH_RATIO: 0.5,
      BATHROOM_INFORMATION_PANEL_EXPAND_ANIMATION_DURATION_MS: 250,
      BATHROOM_INFORMATION_PANEL_EXISTENCE_VOTE_BAR_TEXT_COLOR_BRIGHTNESS_MULT_FACTOR: 0.75,
      BATHROOM_EXISTENCE_VOTE_BUTTON_TEXT_COLOR_BRIGHTNESS_MULT_FACTOR: 0.5,
